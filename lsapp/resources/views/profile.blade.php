...
@section('content')
    ...
    <footer id="main-footer" class="grid">
        ...
        <div>Copyright Kiran Anand 2021</div>
        <div>Proceed to <a href="{{ route('home') }}">Main Website</a></div>
